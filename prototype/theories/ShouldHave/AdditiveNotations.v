...
Notation "x '-' y" := (bin_op x (endo_fn y)) : algebra_scope.
...
Notation "x '+<' y" := (l_ex_bin_op x y) : algebra_scope.
Notation "x '>+' y" := (r_ex_bin_op x y) : algebra_scope.
Notation "'>-<' x" := (fn x) : algebra_scope.
Notation "x '-<' y" := (l_ex_bin_op x (fn y)) : algebra_scope.
Notation "x '>-' y" := (r_ex_bin_op x (fn y)) : algebra_scope.
