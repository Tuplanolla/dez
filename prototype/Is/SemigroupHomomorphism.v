...
Class IsSemigroupHomomorphism {A B : Type} {A_has_eqv : HasEqv A}
  ...
  semigroup_homomorphism_A_B_hom_is_setoid_homomorphism :>
    IsSetoidHomomorphism (A := A) (B := B) hom;
  semigroup_homomorphism_preserves_operation : forall x y : A,
    hom (x + y) == hom x + hom y;
  semigroup_homomorphism_A_opr_is_semigroup :> IsSemigroup (A := A) opr;
  semigroup_homomorphism_B_opr_is_semigroup :> IsSemigroup (A := B) opr;
}.
