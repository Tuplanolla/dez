...
(** We export [StrictProp] to be able to
    ...
    that would be automatically generated by the equations plugin and
    export [Equations] to make use of the equations plugin.
    All imports and exports are carried out before setting options,
    because we want to ensure that our options remain unchanged. *)
