...
(** Associate the arguments of two nested calls
    ...
    - [replace (f (f 0 1 2) 3 v)]
      - [with (f (f 0 1 2) 3 v) by idtac]
      - [with (f 0 (f 1 2 3) v) by rewrite assoc_3_0_1]
    - [replace (f (f 0 1 2) w 4) with (f (f 0 1 2) w 4) by idtac]
    - [replace (f (f 0 1 2) w v) with (f (f 0 1 2) w v) by idtac]
    - [replace (f (f 0 1 z) 3 4) with (f (f 0 1 z) 3 4) by fail]
    - [replace (f (f 0 1 z) 3 v) with (f (f 0 1 z) 3 v) by fail]
    - [replace (f (f 0 1 z) w 4) with (f (f 0 1 z) w 4) by fail]
    - [replace (f (f 0 1 z) w v) with (f (f 0 1 z) w v) by fail]
    - [replace (f (f 0 y 2) 3 4) with (f 0 y (f 2 3 4))
      by rewrite assoc_3_0_1, assoc_3_1_2]
    - [replace (f (f 0 y 2) 3 v) with (f (f 0 y 2) 3 v) by fail]
    - [replace (f (f 0 y 2) w 4) with (f (f 0 y 2) w 4) by fail]
    - [replace (f (f 0 y 2) w v) with (f (f 0 y 2) w v) by fail]
    - [replace (f (f 0 y z) 3 4) with (f (f 0 y z) 3 4) by fail]
    - [replace (f (f 0 y z) 3 v) with (f (f 0 y z) 3 v) by fail]
    - [replace (f (f 0 y z) w 4) with (f (f 0 y z) w 4) by fail]
    - [replace (f (f 0 y z) w v) with (f (f 0 y z) w v) by fail]
    - [replace (f (f x 1 2) 3 4)]
      - [with (f x (f 1 2 3) 4) by rewrite assoc_3_0_1]
      - [with (f x 1 (f 2 3 4)) by rewrite assoc_3_0_1, assoc_3_1_2]
    - [replace (f (f x 1 2) 3 v) with (f x (f 1 2 3) v)
      by rewrite assoc_3_0_1]
    - [replace (f (f x 1 2) w 4) with (f (f x 1 2) w 4) by fail]
    - [replace (f (f x 1 2) w v) with (f (f x 1 2) w v) by fail]
    - [replace (f (f x 1 z) 3 4) with (f (f x 1 z) 3 4) by fail]
    - [replace (f (f x 1 z) 3 v) with (f (f x 1 z) 3 v) by fail]
    - [replace (f (f x 1 z) w 4) with (f (f x 1 z) w 4) by fail]
    - [replace (f (f x 1 z) w v) with (f (f x 1 z) w v) by fail]
    - [replace (f (f x y 2) 3 4) with (f x y (f 2 3 4))
      by rewrite assoc_3_0_1, assoc_3_1_2]
    - [replace (f (f x y 2) 3 v) with (f (f x y 2) 3 v) by fail]
    - [replace (f (f x y 2) w 4) with (f (f x y 2) w 4) by fail]
    - [replace (f (f x y 2) w v) with (f (f x y 2) w v) by fail]
    - [replace (f (f x y z) 3 4) with (f (f x y z) 3 4) by fail]
    - [replace (f (f x y z) 3 v) with (f (f x y z) 3 v) by fail]
    - [replace (f (f x y z) w 4) with (f (f x y z) w 4) by fail]
    - [replace (f (f x y z) w v) with (f (f x y z) w v) by fail]
